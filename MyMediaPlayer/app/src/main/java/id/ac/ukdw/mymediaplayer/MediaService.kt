...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "id.ac.ukdw.mymediaplayer.mediaservice.create"
        const val ACTION_DESTROY = "id.ac.ukdw.mymediaplayer.mediaservice.destroy"
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.ed_sheeran)
        try {
